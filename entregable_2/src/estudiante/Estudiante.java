...
public class Estudiante {
	...
	public Estudiante(String nombre, String apellido, int edad, String genero, String dni,
			String ciudad, int nro_libreta, ArrayList<Carrera> carreras) {
		super();
		this.nombre = nombre;
	...
	public String toString() {
		return "Estudiante [idEstudiante=" + idEstudiante + ", nombre=" + nombre + ", apellido=" + apellido + ", edad="
				+ edad + ", genero=" + genero + ", dni=" + dni + ", ciudad=" + ciudad + ", nro_libreta=" + nro_libreta
				+ "]";
	}
